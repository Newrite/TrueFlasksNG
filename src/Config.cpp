  ...
  private:
    ...
    void read_flask_base(const mINI::INIStructure& ini, const std::string& section, flask_settings_base& settings)
    {
      ...
      if (ini.has(section)) {
        ...
        if (collection.has("FlasksEnableParallelCooldown")) parse_bool(collection.get("FlasksEnableParallelCooldown"),
        ...
        if (collection.has("FlasksAntiSpamDelay")) parse_float(collection.get("FlasksAntiSpamDelay"),
                                                               settings.anti_spam_delay);

        if (collection.has("FlasksRegenerationMultBase")) parse_float(collection.get("FlasksRegenerationMultBase"),
        ...
        if (collection.has("FlasksCooldownBase")) parse_float(collection.get("FlasksCooldownBase"),
  ...
  public:
    ...
    auto load() -> void
    {
      ...
      if (ini.has("FlasksOther")) {
        ...
        if (sec.has("FlasksRevertExclusive")) parse_bool(sec.get("FlasksRevertExclusive"),
      ...
      if (ini.has("PrismaWidget")) {
        ...
        if (sec.has("PrismaAnchorAllElements")) parse_bool(sec.get("PrismaAnchorAllElements"),
